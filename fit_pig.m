...
icp_data.max_distance_sq = 1e+6;  % Optional parameter
icp_data.cos_normal_threshold = 0.9;  % Optional parameter
icp_data.method = 3;  % Optional parameter
...
% scatter3(pig.Position(1,:), pig.Position(2,:), pig.Position(3,:),'k.');
